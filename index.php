...
<body>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="logout.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Logout</a>
            </li>				
        </ul>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2023 <a class="grey-text text-lighten-4" href="#" target="_blank">Ashlya Tech</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Bishal Regmi</a></span>
        </div>
    </div>
  </footer>
